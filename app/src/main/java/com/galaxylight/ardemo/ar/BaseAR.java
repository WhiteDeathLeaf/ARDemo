...
public abstract class BaseAR {
    ...
    public CameraFrameStreamer streamer;
    public ArrayList<ImageTracker> trackers;
    public Renderer videobg_renderer;

    public boolean viewport_changed = false;
    public Vec2I view_size = new Vec2I(0, 0);
    public int rotation = 0;
    public Vec4I viewport = new Vec4I(0, 0, 1280, 720);
    ...
    private void loadFromImage(ImageTracker tracker, String path) {
        ...
        String jstr = "{images[{image:" + path + ",name:" + path.substring(0, path.indexOf(".")) + "}]}";
    ...
    public abstract void doRender(Frame frame);
}
